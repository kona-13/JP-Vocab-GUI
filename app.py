# -*- coding: utf-8 -*-
"""
Created on Tue Jan  2 11:58:04 2024
...
#font = tkfont.Font(family="Noto Sans CJK JP")

label = tk.Label(root, text="Click the button, or press space for new word", font=('Noto Sans CJK JP', 25), wraplength=300)
